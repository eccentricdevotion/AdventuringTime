 ...
 * @author eccentric_nz
 */
public class AdventuringTimeTARDIS {
    ...
    static {
        ...
        lookup.put("Mega Taiga", "MEGA_TAIGA");
        lookup.put("Mega Taiga Hills", "MEGA_TAIGA_HILLS");
        lookup.put("Mesa", "MESA");
        lookup.put("Mesa Plateau", "MESA_PLATEAU");
        lookup.put("Mesa Plateau F", "MESA_PLATEAU_FOREST");
        lookup.put("Mushroom Island", "MUSHROOM_ISLAND");
        lookup.put("MushroomIslandShore", "MUSHROOM_SHORE");
        lookup.put("Ocean", "OCEAN");
        lookup.put("Plains", "PLAINS");
